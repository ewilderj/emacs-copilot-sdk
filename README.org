...
- *echo-bot* — minimal hello world (~35 lines)
- *docstring* — generate docstrings for functions at point
- *commit-message* — AI commit messages in a vc-style popup buffer
- *org-process* — AI-powered GTD inbox processor for org-mode
